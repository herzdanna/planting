<header class="bg-blue position-relative overflow-hidden pt-10">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md offset-md-2" style="z-index: 10;">
                    <h1 class="d-inline-block bg-white text-primary fw-bold rounded-top py-3 px-4 mb-0"><?=lang("Blog.title")?></h1>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="bg-secondary py-6" id="post1">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h1 id="post1-title" class="text-primary h3 fw-bold mb-0"><?=$stories[0]["title_${locale}"]?></h1>
            </div>
            <div class="clearfix">
    ...
    <section class="bg-green py-6" id="post2">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h1 class="text-primary h3 fw-bold mb-0"><?=$stories[1]["title_${locale}"]?></h1>
            </div>
            <div class="clearfix">
    ...
    <section class="bg-blue py-6" id="post3">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h1 id="post3-title" class="text-primary h3 fw-bold mb-0"><?=$stories[2]["title_${locale}"]?></h1>
            </div>
            <div class="clearfix">
                <img id="post3-img" src="<?=$stories[2]["routeImg"]?>" class="col-md-6 float-md-start mb-3 me-md-3 img-fluid" alt="...">
                <div id="post3-content">
                <?=$stories[2]["description_${locale}"]?>
                </div>
            </div>
        </div>
    </section>
