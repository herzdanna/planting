...
return [
    ...
    "whereAre" => [
        ...
        "text1" => "While we believe that early childhood education is the foundation to break the cycle of poverty, we recognized that with such marginalized communities, our approach needed to be more comprehensive.",
    ...
    "position" =>  [
        ...
        "coDirector" => "Co-Executive Director of Planting Seeds International",
        "academic" => "Executive Director and Academic Director of Planting Seeds International",
        "academicCoordinator" => "Academic and Pedagogical Coordinator of Planting Seeds International",
        "academicPreschool" => "Academic Coordinator and Preschool Teacher of Planting Seeds International",
        "cominications" => "Communications and Development Officer",
        "publicRelations" => "Public Relations Coordinator",
        "teacher" => "eacher in",
        "administrative" => "Adminitrative Support",
        "maintenance" => "Maintenance and Cleaning",
        "nutrition" => "Nutrition Program Cook in ",
        "facilitator" => "After school facilitator",
        "gogirlsAfter" => "Go Grils! and After school facilitator",
        "fathergroups" => "Fathers' group facilitator ",
        "library" => "library Coordinator",
        "pedagogue" => "Pedagogue off community programs ",
        "gogirls" => "Go Grils! facilitator ",
        "librarian" => "librarian",
        "motivated" => "Motivated women facilitator",
        "photographer" => "Photographer",
        "Women" => "Motivated Women Facilitator",
    ],
    "partners" => [
        "title" => "Our partners",
