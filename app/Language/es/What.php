...
return [
    ...
    "earlyEducation" => [
        "title" => "Educación de Primera Infancia",
        "content" => "El programa educativo de  Plantando Semillas se centra en el bienestar de las y los niños, por medio de:  educación basada en  actividades y un modelo de enseñanza primaria centrado en una filosofía de amor y cuidado cariñoso y sensible. Esto, con el objetivo de proveer educación integral para niñas y niños en una gama amplia de niveles: físico, emocional, social, intelectual, creativo y espiritual.",
        "content2" => "A través de nuestro modelo de educación preescolar, implementado exitosamente en San Lucas, Sacatepequez, ofrecemos una metodología que beneficia a comunidades, municipalidades y organizaciones sin fines de lucro en Guatemala, que busca mejorar el panorama de la educación en el país."
    ], 
    "flipingSquares" => [
        "square1" =>  [
            "title" => "Nuestra Filosofía",
            "content" => "Los programas de  Plantando Semillas se centran en una filosofía de amor, crianza y cuidado. A diferencia de la opinión ampliamente aceptada de que el objetivo principal de la educación es proporcionar habilidades para futuras carreras, Plantando Semillas se esfuerza por preparar a los niños para la VIDA.",
        ],
        "square2" => [
            "title" => "Metodología de Enseñanza Acreditada",
