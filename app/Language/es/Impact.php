...
return [
    ...
    "work" =>  [
        ...
        "text1" => " Los estudiantes de Planting Seeds están significativamente más preparados para el primer grado que los estudiantes de escuelas vecinas, tanto públicas como privadas. Además, en Guatemala, donde más del 22% de los estudiantes fracasan en el primer grado, 97% de los estudiantes egresados de un programa educativo de Planting Seeds pasan el primer grado en sus respectivas escuelas. Actualmente realizamos un estudio a largo plazo en Sacala, en aras de medir el impacto duradero de nuestros programas preescolares.",        
        "text2" => "Aunque estamos orgullosos de estas cifras, el éxito de nuestros programas se experimenta mejor de primera mano. Las lágrimas, las sonrisas, las conexiones, la formación del carácter y el aprendizaje individualizado son, a veces, más poderosos de lo que los números pueden representar. Esperamos que puedas visitar nuestras instalaciones y explorar nuestros programas en persona para ser testigo del poder de nuestro trabajo con la vida de las niñas y niños, así como sus familias."
    ],
    "square3" => [
        "title" => "220",
    ...
    "square6" => [
        ...
        "text1" => "En nuestra escuela asociada REKKO, los estudiantes de Planting Seeds",
