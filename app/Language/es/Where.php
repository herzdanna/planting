...
return [
    ...
    "Beneficiaries" => "Beneficia",
    "Ages" => "Edades",
    "Context" => "Contexto",
    "Programs" => "Acciones adicionales en el área ",
    "button" => "Inspirate con nuestro impacto",
    "place1" => [
        ...
        "Agestxt" => "2 a 6 años",
        "Contexttext" => "Sede se encuentre en una comunidad marginal, con bajo acceso a empleabilidad e índices altos de violencia doméstica y violencia comunitaria",
        "program1" => [
            "name" => "Nuestra metodología:",
            "item" => "Trabajamos de la mano con dos escuelas aliadas:",
            "item1" => "Esperanza Renovada (50 estudiantes, de 4 a 6 años)",
            "item2" => "Iniciativa Guatemala (con estudiantes de 2 a 3 años, quienes van a la escuela con preescolar junto a sus padres y madres de familia)",
        ],
        "program2" => [
            "name" => "Centro Comunitario:",
            "item" => "Espacio comunitario abierto a las y los vecinos y organizaciones del área, los siete días de la semana de 6am a 9pm. Nuestros programas comunitarios son liderados por integrantes de la comunidad.",
        ],
        "program3" => [
    ...
    "place2" => [
        ...
        "program2" => [
            ...
            "item" => " Brindamos capacitaciones mensuales personalizadas para padres, brindando recursos, conocimientos y habilidades para apoyar mejor el desarrollo de sus hijos.",
        ],
        "program3" => [
        ...
        "program4" => [
            ...
            "item" => "Los niños se llevan cuatro libros a casa cada mes y los padres reciben formación creando pequeños lectores para implantar el hábito de la lectura en casa. ",
        ],
        "program5" => [
            "name" => "Programa de nutrición:",
            "item" => "Los niños reciben una comida saludable todos los días en nuestros programas y los padres y los niños reciben capacitación sobre cómo satisfacer las necesidades nutricionales de sus familias.",
        ],
    ], 
    "place3" => [
        ...
        "Agestxt" => "4 a 6 años",
        "Contexttext" => "la sede se encuentra en un área remota del altiplano occidental guatemalteco, donde habitan integrantes de las comunidades Maya y Kaqchikel, poblaciones que históricamente mantienen bajo acceso a educación de calidad.",
        "program1" => [
            "name" => "Preescolar PS:",
            "item" => " Nuestro programa de preescolar, liderado por Mérida Yucute y Norma Atz tiene entre 20-24 alumnos anualmente. El preescolar se acompaña de los servicios complementarios.",
        ],
        "program2" => [
            "name" => "Programa de capacitación para padres:",
            "item" => " Brindamos capacitaciones mensuales personalizadas para padres, brindando recursos, conocimientos y habilidades para apoyar mejor el desarrollo de sus hijos.",
        ...
        "program4" => [
            "name" => "Programa de Préstamo de Libros: ",
            "item" => "Los niños se llevan cuatro libros a casa cada mes y los padres reciben capacitación creando pequeños lectores para implantar el hábito de la lectura en casa.",
        ],
        "program5" => [
            "name" => "Programa de nutrición:",
            "item" => " Los niños reciben una comida saludable todos los días en nuestros programas y los padres y los niños reciben capacitación sobre cómo satisfacer las necesidades nutricionales de sus familias.",
    ...
    "place4" => [
        ...
        "Foundationtext" => "2008",
        "Beneficiariestext" => "15 niñas y niños al año",
        "Agestxt" => "3 a 6 años  ",
        "Contexttext" => "la sede se encuentra en un área remota del altiplano occidental guatemalteco, donde habitan integrantes de las comunidades Maya y Kaqchikel, poblaciones que históricamente mantienen bajo acceso a educación de calidad. ",
        "program1" => [
            "name" => "PS Preescolar: ",
            "item" => " Nuestro programa de preescolar, dirigido por María Juana Armira Ávila, tiene entre 12 y 15 alumnos al año.",
        ],
        "program2" => [
            "name" => "Programa de Capacitación para Padres:",
            "item" => " Brindamos capacitaciones mensuales personalizadas para padres, brindando recursos, conocimientos y habilidades para apoyar mejor el desarrollo de sus hijos.",
    ...
    "place5" => [
        ...
        "Foundationtext" => "2015 (en alianza con la organización REKKO Organization).",
        "Beneficiariestext" => "50 niñas y niños al año",
        "Agestxt" => " 4 a 6 años",
        "Contexttext" => "la sede se encuentra en un área remota del altiplano occidental guatemalteco, donde habitan integrantes de las comunidades Maya y Kaqchikel, poblaciones que históricamente mantienen bajo acceso a educación de calidad, servicios de salud y programas de nutrición. A través del trabajo conjunto con REKKO, se ofrecen servicios que atienden las necesidades anteriormente mencionadas en la comunidad.",
        "program1" => [
            "name" => "Nuestra metodología:",
            "item" => " Plantando Semillas capacita al Equipo Educativo de REKKO para implementar la metodología PS a 44 estudiantes anualmente. PS ha implementado la metodología aquí desde 2015",
        ],
        "program2" => [
            "name" => "Programa de capacitación para padres:",
            "item" => " Brindamos capacitaciones mensuales personalizadas para padres, brindando recursos, conocimientos y habilidades para apoyar mejor el desarrollo de sus hijos.",
